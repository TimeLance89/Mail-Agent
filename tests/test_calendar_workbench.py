...
def test_calendar_workbench_is_loaded_and_cache_busted():
    ...
    assert "/assets/calendar-workbench.js?v=0.18.0" in index
    assert "/assets/calendar-mail-suggestions.js?v=0.18.0" in index
    assert "/assets/v171-ux.js?v=0.18.0" in index
    assert "/assets/v172-ux.js?v=0.18.0" in index
    assert index.index("/assets/calendar-workbench.js?v=0.18.0") < index.index(
        "/assets/calendar-mail-suggestions.js?v=0.18.0"
    )
    assert index.index("/assets/dashboard-live.js?v=0.18.0") < index.index(
        "/assets/v171-ux.js?v=0.18.0"
    )
    assert index.index("/assets/v171-ux.js?v=0.18.0") < index.index(
        "/assets/v172-ux.js?v=0.18.0"
    )
