...
def test_workbench_is_first_class_and_adaptive_assets_are_loaded():
    ...
    assert "/assets/workbench.css?v=0.16.0" in index
    assert "/assets/workbench-ui.js?v=0.16.0" in index
    assert "/assets/adaptive-intelligence.css?v=0.16.0" in index
    assert "/assets/adaptive-intelligence-ui.js?v=0.16.0" in index
    assert "/assets/dashboard-live.js?v=0.16.0" in index
