...
def test_release_version_is_synchronized_for_0180():
    ...
    assert 'version = "0.18.2"' in pyproject
    ...
    assert 'app_version: str = "0.18.2"' in identity
    assert '#define MyAppVersion "0.18.2"' in installer
    assert "const APP_VERSION = '0.18.2'" in desktop
    assert '"version": "0.18.2"' in codex
    ...
    assert "/assets/desktop-links.js?v=0.18.2" in index
