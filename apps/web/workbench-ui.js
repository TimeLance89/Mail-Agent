  ...
  dashboardLayout = function workbenchLayout(content) {
    ...
    return `<main class="wb-shell">
      ...
      <aside class="wb-context">
        <div class="wb-brand"><div><span class="wb-brand-title">MAIL-AGENT</span><span class="wb-brand-sub">${esc(agentName)} · persönlicher Operations Agent</span></div><span class="wb-build">0.17.3</span></div>
